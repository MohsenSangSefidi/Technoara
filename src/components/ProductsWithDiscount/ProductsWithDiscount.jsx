...
export default function ProductsWithDiscount() {
  return (
    <div className='flex cursor-pointer relative flex-col w-[100%] h-[30rem] gap-2 shadow-xl transition-all hover:bg-[#EFF0F5] p-5 rounded-lg'>
