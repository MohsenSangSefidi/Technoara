...
export default function ProductsWithNoDiscounts() {
  return (
    <div className='flex cursor-pointer relative flex-col w-[100%] h-[30rem] gap-2 shadow-xl transition-all hover:bg-[#EFF0F5] p-7 rounded-lg'>
    <div className='w-[14rem] mx-auto h-[14rem]'>
      <img src="public/images/products/1-10.jpg" className='w-[100%] h-[100%]' alt="" />
    ...
    <div className='flex items-center justify-between'>
      <div className='bg-primary p-4 text-white rounded-xl'><button className='font-YekanBakh'>افزودن به سبد</button></div>
