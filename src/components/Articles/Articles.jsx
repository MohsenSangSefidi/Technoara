  ...
  return (
    <section className='mt-20'>
      <TitleBox title={"وبلاگ"} link={"مشاهده"}/>
       <div className='flex items-center h-[27rem] justify-center gap-6 mt-10'>
          <div className='w-[55%] relative h-[100%]'>
           <div className='w-[100%] h-[100%] overflow-hidden rounded-2xl'>
            <img src="public/images/articles/3-11.jpg" className='w-full h-full' alt="" />
           </div>
           <div className='absolute flex flex-col gap-7 justify-end pb-9 pr-5 article-box__bg left-0 top-0 right-0 rounded-2xl bottom-0 bg-[rgba(0,0,0,0.4)]'>
               ...
               <div className='flex items-center text-white gap-8 justify-start'>
          ...
          <div className='w-[45%] flex flex-col gap-7 h-[100%] items-start justify-start'>
              <ArticleBox />
              <ArticleBox />
              <ArticleBox />
          </div>
